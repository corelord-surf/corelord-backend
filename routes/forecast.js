...
router.get("/timeseries", async (req, res) => {
  try {
    ...
    // Map cached hours -> frontend schema
    const items = json.hours.map((entry) => ({
      ...
      // directions / period for tooltips + detail charts
      ...
      // TIDE — strictly from cache (written by routes/cache.js as tideHeight)
